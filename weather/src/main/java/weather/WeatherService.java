...
import weather.components.WeatherResponse;
...
public class WeatherService {
    ...
    private WeatherResponse getWeatherResponse(Long time) throws IOException {
        ObjectMapper objectMapper = new ObjectMapper();
        return objectMapper.readValue(getResponse(time), WeatherResponse.class);
    }

    public ArrayList<Pair<String, Double>> getDateTemperatureByLastDays(Integer lastDays) throws IOException {
    ...
    public ArrayList<Double> getTemperatureByLastDays(Integer lastDays) throws IOException {
